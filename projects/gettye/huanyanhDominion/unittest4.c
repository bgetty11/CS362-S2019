...
int main()
{
	...
	_adventurer(&testG, thisPlayer, drawnTreasure, z, tempHand);
	newCards = 2;
	discarded = 1;
	...
	_adventurer(&testG, thisPlayer, drawnTreasure, z, dempHand);
	...
	_adventurer(&testG, thisPlayer, drawnTreasure, z, pempHand);
	...
	_adventurer(&testG, thisPlayer, drawnTreasure, z, rempHand);
	...
	_adventurer(&testG, thisPlayer, drawnTreasure, z, lempHand);;
	...
	_adventurer(&testG, thisPlayer, drawnTreasure, z, sempHand);
